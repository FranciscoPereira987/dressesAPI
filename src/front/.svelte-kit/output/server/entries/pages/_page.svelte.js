import { c as create_ssr_component, d as compute_rest_props, a as setContext, f as spread, h as escape_object, i as escape_attribute_value, j as add_attribute, g as getContext, v as validate_component, e as escape, k as compute_slots, l as createEventDispatcher, o as each } from "../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `<form id="search-form">${validate_component(Search, "Search").$$render(
      $$result,
      { value },
      {
        value: ($$value) => {
    ...
    )}</form> ${results.length > 0 ? `<div class="group">${validate_component(Listgroup, "Listgroup").$$render($$result, { items: results, class: "list" }, {}, {
      default: ({ item }) => {
        return `${validate_component(ListgroupItem, "ListgroupItem").$$render($$result, { class: "listItem" }, {}, {
          default: () => {
            return `<img${add_attribute("src", item.url, 0)} alt="Cat">`;
          }
        })}`;
      }
    })}</div>` : ``}`;
